$(document).ready(function() {
	...
	var obj = {
        ...
        'Przestępstwa lekkie': {
		...
		}, 'Przestępstwa związane z brońmi i nielegalnymi substancjami': {
			...
			'Naruszenie nietykalnośći cielesnej': {
                'Dodatkowe': '',
                'Kwota min': 2000,
                'Kwota max': 5000,
                'Więzienie min': 5,
    ...
    $('#show').click(function() {
        ...
        $('input:checkbox:checked').each(function() {
			...
			var q2 = quantity.val();
			// dodawanie zaznaczonych wartośći do 5 tablic
			if (q2 <= 1) {
		...
		if(wyrok == ''){
			...
			if(maxWiezienie > 0){
				...
				setTimeout(function(){
					alertify.alert("<b>Wyrok:</b><br>"+wyrok+"<br><br><b>Proponowana kara:</b><br>Grzywna: Od "+minKwota+"$ do "+maxKwota+"$<br>Więzienie: Od "+minWiezienie+" miesięcy do "+maxWiezienie+" miesięcy<br>Dodatkowe: "+dodatkowe, ).setting({
